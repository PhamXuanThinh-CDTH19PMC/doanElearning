			...
			<div class="header-bottom">
				<div class="header-right w3agile">
					...
					<div class="header-left-bottom agileinfo">
					 ...
					 <form action="#" method="post">
						<input type="text"  value="Tên tài khoản" name="ten_tai_khoan" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'User name';}"/>
...
</html><?php /**PATH C:\Users\admin\doanElearning\DoAnElearning\resources\views/login.blade.php ENDPATH**/ ?>